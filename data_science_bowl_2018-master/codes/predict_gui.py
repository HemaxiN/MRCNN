# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 15:21:21 2019
...
def pred_n_plot_test(model, config, img, save_plots=False):
    """
...
# =============================================================================
    ...
    #import cv2
    #img = cv2.imread(r"D:/Ambiente_de_Trabalho/Tese/NCV/8/Images/FS6_3_40xoil_60Zs_deconv_9.tif")
