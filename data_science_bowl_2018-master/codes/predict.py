...
def pred_n_plot_test(model, config, test_path='../data/stage2_test_final/', save_plots=False):
    ...
    for img in os.listdir(test_path):
        # Load the image
        image = load_img(os.path.join(test_path,img), color=config.IMAGE_COLOR)
...
# =============================================================================
        ...
        if save_plots:
            ...
            #fig.savefig('../images/' + img , bbox_inches='tight')
            #plt.close()
            
            import pickle
            #pickle_out = open(r'D:/Ambiente_de_Trabalho/Tese/Code/Mask_RCNN_5thPLACE_Kaggle/data_science_bowl_2018-master/codes/mask_rcnn_code/predictions/1/' + img + '.pickle', "wb")
            #pickle_out = open(r'D:/Ambiente_de_Trabalho/Tese/FUCCI/NCV/10/test/mask_rcnn_pred/' + img + '.pickle', "wb")
            #pickle_out = open(r'D:/Ambiente_de_Trabalho/Tese/FUCCI/NCV/10/test/mask_rcnn_pred_norm/' + img + '.pickle', "wb")
            #pickle_out = open(r'D:/Ambiente_de_Trabalho/Tese/SF/predictions/' + img + '.pickle', "wb")
            pickle_out = open(r'C:/Users/hemax/Desktop/Nova pasta/pred/' + img + '.pickle', "wb")
            pickle.dump(result['masks'], pickle_out)
            pickle_out.close()
...
# =============================================================================
#     import numpy as np
#     segmentation_mask = result['masks']
...
# =============================================================================
    ...
    #path = r"D:/Ambiente_de_Trabalho/Tese/NCV/1/Images/"
    #path = r'D:/Ambiente_de_Trabalho/Tese/Images/CellImages/Blue_Channel/'
    #path = r'C:/Users/hemax/Desktop/Mock/Blue Channel/'
    start = time.time()
    #path =r'D:\Ambiente_de_Trabalho\Tese\FUCCI\NCV\10\test\images_norm'
    path = r'C:\Users\hemax\Desktop\Nova pasta'
    #path = r'D:/Ambiente_de_Trabalho/Tese/Images/CellImages/Blue_Channel_SF/'
    pred_n_plot_test(model, config, test_path=path, save_plots=True)
